...
Este script define os corredores do labirinto. Isso permite que fantasmas e o jogador os ditem
posições acessíveis na janela.
...
# Criamos um dicionário que contém as coordenadas das interseções entre os corredores
# quais são as posições em que os personagens podem virar
...
# lista de corredores definidos por um quádruplo agrupando as abscissas e ordenadas de suas extremidades
...
# lista composta de listas com dois ou três elementos, que são os números de pares / triplos vizinhos
...
# gráfico representando os pontos (os vizinhos no gráfico são exatamente os vizinhos no labirinto)
